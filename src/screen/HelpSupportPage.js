        ...
        >
          ...
          <View style={styles.tabRow}>
            ...
            <View style={styles.tabItemActive}>
              <MaterialIcons name="help-outline" size={22} color="#00C29B" />
            ...
            <View style={styles.tabItem}>
              <MaterialIcons name="bug-report" size={22} color="#9FA4B3" />
              <Text style={styles.tabText}>Report a Bug</Text>
            </View>

            <View style={styles.tabItem}>
              <MaterialIcons name="lightbulb-outline" size={22} color="#9FA4B3" />
              <Text style={styles.tabText}>Suggest a Feature</Text>
            </View>

            <View style={styles.tabItem}>
              <MaterialIcons name="star-border" size={22} color="#9FA4B3" />
